// Source : https://github.com/erichschroeter/cmake-auto-increment-build-number
...
int main(int argc, char **argv) {
    ...
    printf("#ifndef H_BUILD_NUMBER_H\n"             \
           ...
           "#define %s_VERSION \"%d.%d.%d%s\"\n"           \
           "#define %s_COMPILE_TIMESTAMP %ld\n"            \
           "#define %s_COMPILE_DATE \"%s\"\n"              \
           "#define %s_COMPILE_TIME \"%s\"\n"              \
           "\n"                                            \
           "#endif /* H_BUILD_NUMBER_H */\n",
           prefix, major,
           prefix, minor,
           prefix, patch,
           prefix, meta,
           prefix, build,
           prefix, major, minor, patch, meta,
           prefix, timer,
           prefix, datestr,
           prefix, timestr);
